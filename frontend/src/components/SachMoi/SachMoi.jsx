    ...
    <div className="SachMoi">
      ...
      <div className="SachMoi__trai">
        <div className="SachMoi__trai__title">
          <h1>Sách Mới</h1>
          <p>
            Sách Mới Phát Hành - Nhà sách trên mạng lớn nhất Việt nam, với trên
            30000 đầu sách các loại gồm các chủ đề như: Kinh tế, văn học, tin
            học, thiếu nhi..., ...
          </p>
        </div>
          ...
          <Link to="/theloai">
            <div className="SachMoi__trai__sach__hinhanh">
              <img
                src={
                  sachMoi[0].imgUrl ||
                  process.env.PUBLIC__URL + sachMoi[0].imgUrl
                }
                alt=""
              />
            </div>
          ...
          {sachMoi.map((item, index) => {
            return (
              <div className="SachMoi__phai__item" key={index}>
                ...
                >
                  <img
                    src={item.imgUrl || process.env.PUBLIC__URL + item.imgUrl}
                    alt=""
                  />
                </Link>
              </div>
