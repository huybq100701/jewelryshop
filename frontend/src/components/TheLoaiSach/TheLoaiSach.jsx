...
export const TheLoaiSach = () => {
  ...
  const timKiemButton = () => {
    ...
    if (
      ...
      const timKiemTheoNam = data.filter(
        (item) =>
          Number(item.namXuatBan) >= Number(namBatDau) &&
          Number(item.namXuatBan) <= Number(namKetThuc)
      );
    ...
    if (giaBatDau !== "" && giaKetThuc !== "" && theLoaiSach === "All") {
      if (namBatDau !== "" && namKetThuc !== "") {
        ...
        const timKiemTheoGia = timKiemTheoNam.filter(
          (item) =>
            Number(item.gia) >= Number(giaBatDau) &&
            Number(item.gia) <= Number(giaKetThuc)
        );
        ...
        const timKiemTheoGia = data.filter(
          (item) =>
            Number(item.gia) >= Number(giaBatDau) &&
            Number(item.gia) <= Number(giaKetThuc)
        );
    ...
    if (
      ...
      const timKiemTheoTheLoai = data.filter((item) =>
        item.theLoai.includes(theLoaiSach)
      );
    ...
    if (giaBatDau !== "" && giaKetThuc !== "" && theLoaiSach !== "All") {
      if (namBatDau !== "" && namKetThuc !== "") {
        ...
        const timKiemTheoTheLoai = timKiemTheoGia.filter((item) =>
          item.theLoai.includes(theLoaiSach)
        );
        setDataSapXep(timKiemTheoTheLoai);
        setTrang({
    ...
    if (namBatDau !== "" && namKetThuc !== "" && theLoaiSach !== "All") {
      ...
      const timKiemTheoTheLoai = timKiemTheoNam.filter((item) =>
        item.theLoai.includes(theLoaiSach)
      );
      setDataSapXep(timKiemTheoTheLoai);
      setTrang({
    ...
    <div className="TheLoaiSach">
      <div className="TheLoaiSach__tren">
        <Breadcrumbs aria-label="breadcrumb">
          <Link
            ...
            color="inherit"
            to="/"
            className="TheLoaiSach__tren__link"
          >
            Trang chủ
          </Link>
      ...
      <div className="TheLoaiSach__duoi">
        <div className="TheLoaiSach__duoi__luachon">
          <div className="TheLoaiSach__duoi__luachon__title">Lựa Chọn</div>
          <div className="TheLoaiSach__duoi__luachon__sapxep">
            ...
            <div className="TheLoaiSach__duoi__luachon__sapxep__kieu">
              <FormControl className="TheLoaiSach__duoi__luachon__sapxep__kieu__form">
                <InputLabel id="TheLoaiSach__duoi__luachon__sapxep__kieu__ten">
                  Sắp xếp
                </InputLabel>
                <Select
          ...
          <div className="TheLoaiSach__duoi__luachon__theloai">
            ...
            <div className="TheLoaiSach__duoi__luachon__theloai__luachon">
              ...
              >
                ...
                <option value="Strand of beads">Strand of beads</option>
          ...
          <div className="TheLoaiSach__duoi__luachon__gia">
            ...
            <div className="TheLoaiSach__duoi__luachon__gia__tu__den">
              ...
              <input
                type="text"
                placeholder="VNĐ"
                className="TheLoaiSach__duoi__luachon__gia__tu__den__input"
                name="giaBatDau"
                onChange={doiGiaTri}
                value={giaBatDau}
              />
          ...
          <div className="TheLoaiSach__duoi__luachon__timkiem">
            <div
              className="TheLoaiSach__duoi__luachon__timkiem__timkiem"
              onClick={timKiemButton}
            >
              Tìm Kiếm
            </div>
            <div
              className="TheLoaiSach__duoi__luachon__timkiem__reset"
              onClick={resetButton}
            >
              Reset Tìm Kiếm
            </div>
        ...
        <div className="TheLoaiSach__duoi__danhsach">
          ...
          <div className="TheLoaiSach__duoi__danhsach__items">
            {data.map((item, index) => {
              return index >= (trang.trangHienTai - 1) * trang.soItemMotTrang &&
                index < trang.trangHienTai * trang.soItemMotTrang ? (
                <div className="TheLoaiSach__duoi__danhsach__item" key={index}>
                  <Link
                    to={`/chitiet/${item.id}`}
                    className="TheLoaiSach__duoi__danhsach__item__link"
                  >
                  ...
                  <div className="TheLoaiSach__duoi__danhsach__item__thongtin">
                    ...
                    <div className="TheLoaiSach__duoi__danhsach__item__thongtin__duoi">
                      ...
                      <div className="TheLoaiSach__duoi__danhsach__item__thongtin__duoi__phai">
                        <div
                          className="TheLoaiSach__duoi__danhsach__item__thongtin__duoi__phai__nut"
                          onClick={() => {
          ...
          <div className="TheLoaiSach__duoi__danhsach__chuyentrang">
            <Pagination
              count={Math.ceil(trang.tongSoItem / trang.soItemMotTrang)}
              variant="outlined"
              page={trang.trangHienTai}
              onChange={doiTrang}
              color="primary"
            />
          </div>
