...
const ChiTietSach = ({ id }) => {
  ...
  const themSachGioHang = async () => {
    if (!user.user) {
      ...
      dispatch(add({ item: dulieuSanPham, quantity: soLuong }));
    }
  };
  return (
    <div className="ChiTietSach">
      ...
      <div className="ChiTietSach__duoi">
          ...
          <div className="ChiTietSach__duoi__thongtin">
            <div className="ChiTietSach__duoi__thongtin__anh">
              <img
                src={
                  dulieuSanPham.image
                    ? `http://localhost:8000${dulieuSanPham.image}`
                    : null
                }
                alt="anh"
              />
            ...
            <div className="ChiTietSach__duoi__thongtin__phai">
              ...
              <div className="ChiTietSach__duoi__thongtin__phai__themvaogio">
                <div className="ChiTietSach__duoi__thongtin__phai__themvaogio__gia">
                  <h1>{doiSangPhanNghin(dulieuSanPham.price)} VNĐ</h1>
                </div>
                <div className="ChiTietSach__duoi__thongtin__phai__themvaogio__them">
                  <div className="ChiTietSach__duoi__thongtin__phai__themvaogio__them__soluong">
                    <div
                      className="ChiTietSach__duoi__thongtin__phai__themvaogio__them__soluong__tru"
                      onClick={giamSoLuong}
                    >
                      -
                    </div>
                    ...
                    <div
                      className="ChiTietSach__duoi__thongtin__phai__themvaogio__them__soluong__cong"
                      onClick={tangSoLuong}
                    >
                      +
                    </div>
                  ...
                  <div
                    className="ChiTietSach__duoi__thongtin__phai__themvaogio__them__mua"
                    onClick={() => {
                      themSachGioHang();
                    }}
                  >
        ...
        <div className="ChiTietSach__duoi__comment">
          ...
          {nutShowComment ? (
            <div
              className="ChiTietSach__duoi__comment__showMoreComment"
